...
//**  Getting updates **//
        ...
        bool setWebhook(const QString& url, const QFile* certificate = nullptr, const std::optional<QString>& ip_address = std::nullopt, const std::optional<qint32>& max_connections = std::nullopt, const std::optional<QVector<QString>>& allowed_updates = std::nullopt, const std::optional<bool>& drop_pending_updates = std::nullopt);
...
//**  Main methods  **//
		 ...
		 *
		 * @param chat_id	                    qint32 or QString	                                                                Unique identifier for the target chat or username of the target channel(in the format @channelusername)
         ...
         * 
         * @param chat_id	            qint32 or QString	    Unique identifier for the target chat or username of the target channel (in the format @channelusername)
         * @param from_chat_id	        qint32 or QString	    Unique identifier for the chat where the original message was sent (or channel username in the format @channelusername)
         * @param disable_notification  qint32                  Message identifier in the chat specified in from_chat_id
         * @param message_id            bool                    Optional. Sends the message silently. Users will receive a notification with no sound */
         ...
         * 
         * @param chat_id	                float	                Latitude of new location
         * @param message_id	            float	                Longitude of new location
         * @param inline_message_id	        qint32 or QString       Optional. Required if inline_message_id is not specified. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
         * @param latitude	                qint32	                Optional. Required if inline_message_id is not specified. Identifier of the message to edit
         * @param longitude	                QString	                Optional. Required if chat_id and message_id are not specified. Identifier of the inline message
         * @param horizontal_accuracy	    float	                Optional. The radius of uncertainty for the location, measured in meters; 0-1500
         * @param heading	Integer	        qint32	                Optional. Direction in which the user is moving, in degrees. Must be between 1 and 360 if specified
         ...
         *
         * @param chat_id	          qint32 or QString	    Optional. Required if inline_message_id is not specified. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
         ...
         *
         * @param user_id   qint32    Unique identifier of the target user
         ...
         *
         * @param chat_id	        qint32 or QString	    Unique identifier for the target group or username of the target supergroup or channel (in the format @channelusername)
         * @param user_id	        qint32	                Unique identifier of the target user
         ...
         * 
         * @param chat_id	        qint32 or QString	Unique identifier for the target group or username of the target supergroup or channel (in the format @username)
         * @param user_id	        qint32	            Unique identifier of the target user
         ...
         *
         * @param chat_id	    qint32 or QString	    Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername)
         * @param user_id	    qint32	                Unique identifier of the target user
         ...
         * 
         * @param chat_id   qint32 or String     Unique identifier for the target chat or username of the target channel (in the format @channelusername) */
        ...
        ChatInviteLink createChatInviteLink(const std::variant<qint32, QString>& chat_id,  const std::optional<QString>& name = std::nullopt, const std::optional<qint32>& expire_date = std::nullopt, const std::optional<qint32>& member_limit = std::nullopt, const std::optional<bool> creates_join_request = std::nullopt);
         ...
         * The bot must be an administrator in the chat for this to work and must have the appropriate admin rights
         * 
         * @param chat_id	    qint32 or QString       Unique identifier of the target chat or username of the target channel (in the format @channelusername)
         ...
         * @param chat_id	    qint32 or QString       Unique identifier of the target chat or username of the target channel (in the format @channelusername)
         * @param invite_link   QString	                The invite link to revoke */
        bool approveChatJoinRequest(const std::variant<qint32, QString>& chat_id, const qint32& user_id);
         ...
         * @param chat_id	    qint32 or QString       Unique identifier of the target chat or username of the target channel (in the format @channelusername)
         * @param invite_link   QString	                The invite link to revoke */
        bool declineChatJoinRequest(const std::variant<qint32, QString>& chat_id, const qint32& user_id);
...
//**  Updating messages methods  **//
         ...
         *
         * @param chat_id	                QString	                    New text of the message, 1-4096 characters after entities parsing
         * @param message_id	            qint32 or QString	        Optional. Required if inline_message_id is not specified. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
         * @param inline_message_id	        qint32	                    Optional. Required if inline_message_id is not specified. Identifier of the message to edit
         * @param text	                    QString	                    Optional. Required if chat_id and message_id are not specified. Identifier of the inline message
         ...
         * 
         * @param chat_id	         InputMedia	            An object for a new media content of the message
         * @param message_id	     qint32 or QString	    Optional. Required if inline_message_id is not specified. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
         * @param inline_message_id  qint32	                Optional. Required if inline_message_id is not specified. Identifier of the message to edit
         * @param media	             QString	            Optional. Required if chat_id and message_id are not specified. Identifier of the inline message
         * @param reply_markup       InlineKeyboardMarkup	Optional. Object for an inline keyboard */
...
//**  Stickers related methods  **//
         ...
         *
         * @param user_id       qint32  User identifier of sticker file owner
         ...
         *
         * @param user_id	        qint32	            User identifier of created sticker set owner
        ...
        bool createNewStickerSet(const qint32& user_id, const QString& name, const QString& title, const QString& emojis, const std::optional<std::variant<QFile*, QString>>& png_sticker = std::nullopt, const QFile* tgs_sticker = nullptr, const std::optional<bool>& contains_masks = std::nullopt, const std::optional<MaskPosition>& mask_position = std::nullopt);

        /** @brief Use this method to add a new sticker to a set created by the bot. Returns True on success
         *
         * @param user_id	        qint32	                User identifier of sticker set owner
         * @param name	            QString	                Sticker set name
         * @param png_sticker	    QString	                One or more emoji corresponding to the sticker
         * @param tgs_sticker	    QFile* or QString	    Optional. PNG image with the sticker, must be up to 512 kilobytes in size, dimensions must not exceed 512px, and either width or height must be exactly 512px. Pass a file_id as QString to send a sticker that exists on the Telegram servers (recommended), pass an HTTP URL as a QString for Telegram to get file from the Internet, or upload a new photo using QFile(should be opened)
         * @param emojis	        QFile*	                Optional. TGS animation with the sticker. See https://core.telegram.org/animated_stickers#technical-requirements for technical requirements
         * @param mask_position     MaskPosition	        Optional. An object for position where the mask should be placed on faces */
        bool addStickerToSet(const qint32& user_id, const QString& name, const QString& emojis, const std::optional<std::variant<QFile*, QString>>& png_sticker = std::nullopt, const QFile* tgs_sticker = nullptr, const std::optional<MaskPosition>& mask_position = std::nullopt);
         ...
         *
         * @param name      QString	            Sticker set name
         * @param user_id   qint32	            User identifier of the sticker set owner
...
//**  Inline mode related methods  **//
    ...
    private:
        ...
        std::unique_ptr<WebhookManager> webhook_manager;
