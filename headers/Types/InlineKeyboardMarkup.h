...
namespace Telegram
{
    ...
    struct InlineKeyboardMarkup
    {
         ...
         *
         * QJsonObject which is passed to constuctor has to has JSON array of JSON array of InlineKeyboardButton objects to construct correct object, otherwise empty InlineKeyboardMarkup 
...
//** Fields **//
        ...
        /** @brief QVector of button rows, each represented by an QVector of InlineKeyboardButton objects */
